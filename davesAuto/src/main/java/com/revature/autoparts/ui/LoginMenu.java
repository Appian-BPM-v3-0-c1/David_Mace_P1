            ...
            while (true) {
                ...
                switch (input) {
                    ...
                    case '2':
                        ...
                        break;
                    case '3':
                        new AdminMenu(userService, new OrderHistoryService(new OrderHistoryDAO()), shoppingCartService, storeLocService, new ItemService(new ItemDAO(), new DeptDAO()), user).start();
                        break;
                    case 'x':
                        break exit;
                    default:
