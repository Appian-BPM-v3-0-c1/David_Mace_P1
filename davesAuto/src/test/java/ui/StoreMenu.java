...
public class StoreMenu implements IMenu {
    ...
    private void checkOut(List<ShoppingCart> shoppingCarts) {
        ...
        System.out.println("Thanks for shopping at Daves auto supply");
    ...
    private void myOrderHistory() {
        ...
        while (!exit) {
            ...
            switch (newInput) {
                ...
                case '2':
                    List<OrderHistory> ascList = orderHistoryService.getOrderHistoryDAO().findByDateAsc();
                    if (ascList.isEmpty()) {
                        System.out.println("Invalid Search!");
                    } else {
                ...
                case '3':
                    List<OrderHistory> descList = orderHistoryService.getOrderHistoryDAO().findByDateDesc();
                    if (descList.isEmpty()) {
                        System.out.println("Invalid Search!");
                    } else {
